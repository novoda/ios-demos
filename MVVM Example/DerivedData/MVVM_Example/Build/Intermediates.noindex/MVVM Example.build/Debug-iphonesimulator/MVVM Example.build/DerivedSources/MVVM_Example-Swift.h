...
SWIFT_MODULE_NAMESPACE_PUSH("MVVM_Example")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC12MVVM_Example11AppDelegate")
...
SWIFT_CLASS("_TtC12MVVM_Example21FadeInDismissAnimator")
@interface FadeInDismissAnimator : NSObject <UIViewControllerAnimatedTransitioning>
...
SWIFT_CLASS("_TtC12MVVM_Example21FadeInPresentAnimator")
@interface FadeInPresentAnimator : NSObject <UIViewControllerAnimatedTransitioning>
- (NSTimeInterval)transitionDuration:(id <UIViewControllerContextTransitioning> _Nullable)transitionContext SWIFT_WARN_UNUSED_RESULT;
- (void)animateTransition:(id <UIViewControllerContextTransitioning> _Nonnull)transitionContext;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC12MVVM_Example12ListCellView")
@interface ListCellView : UITableViewCell
...
SWIFT_CLASS("_TtC12MVVM_Example18ListViewController")
...
@interface ListViewController (SWIFT_EXTENSION(MVVM_Example)) <UITableViewDelegate>
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end


SWIFT_CLASS("_TtC12MVVM_Example18ListViewDataSource")
...
SWIFT_CLASS("_TtC12MVVM_Example9Navigator")
...
SWIFT_CLASS("_TtC12MVVM_Example18TransitionDelegate")
...
SWIFT_CLASS("_TtC12MVVM_Example14ViewController")
