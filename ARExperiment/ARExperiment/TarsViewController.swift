...
class TarsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        modelNodeModel = createSceneNodeForAsset(modelNodeName, assetPath: "art.scnassets/sleek.scn")
        lightNodeModel = createSceneNodeForAsset(lightNodeName, assetPath: "art.scnassets/sleek.scn")
        planeNodeModel = createSceneNodeForAsset(planeNodeName, assetPath: "art.scnassets/sleek.scn")
...
extension TarsViewController: ARSCNViewDelegate {
